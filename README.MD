...
# DustPress Starter Theme (ARCHIVED)

This repository contains the old starter theme for Geniem WordPress projects using [DustPress](https://github.com/devgeniem/dustpress/). This project is no longer updated.
